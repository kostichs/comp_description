...
# from .sessions import cleanup_old_sessions  # TODO: Fix import after refactoring

# Добавляем путь к criteria_processor в sys.path СРАЗУ
# backend/api/criteria/routes.py -> backend/api/criteria -> backend/api -> backend -> project_root
